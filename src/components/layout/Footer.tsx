    ...
    <footer className="bg-card border-t border-border text-card-foreground pt-16 pb-8 font-persian">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <address className="not-italic text-sm text-muted-foreground space-y-2">
              ...
              <p>ایمیل: <a href="mailto:info@sorenathletics.com" className="hover:text-primary">info@sorenathletics.com</a></p>
              <p>تلفن: <a href="tel:07138247977" className="hover:text-primary">۳۸۲۴۷۹۷۷-۰۷۱</a> / <a href="tel:07138342622" className="hover:text-primary">۳۸۳۴۲۶۲۲-۰۷۱</a></p>
            </address>
          </div>
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex gap-2">
              <Input type="email" placeholder="ایمیل شما" className="flex-grow" aria-label="ورودی ایمیل خبرنامه"/>
        ...
        <div className="border-t border-border pt-8 mt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} باشگاه ورزشی سورن. تمامی حقوق محفوظ است.</p>
          <p className="mt-1">
